...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "clickup-pp-cli",
		Short: `Clickup CLI — Every ClickUp v2 + v3 endpoint as a typed CLI plus offline sync, search, and ergonomic chat/docs aliases.`,
		Long: `Clickup CLI — Every ClickUp v2 + v3 endpoint as a typed CLI plus offline sync, search, and ergonomic chat/docs aliases.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'clickup-pp-cli profile list')")
	...
	rootCmd.AddCommand(newGoalCmd(flags))
	rootCmd.AddCommand(newGroupCmd(flags))
	rootCmd.AddCommand(newKeyResultCmd(flags))
	rootCmd.AddCommand(newListCmd(flags))
	rootCmd.AddCommand(newSpaceCmd(flags))
	...
	rootCmd.AddCommand(newDocsAliasCmd(flags))
	rootCmd.AddCommand(newChatAliasCmd(flags))
