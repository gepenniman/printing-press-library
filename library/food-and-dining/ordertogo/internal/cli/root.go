...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Browse, cart, and place orders at any OrderToGo.com restaurant from the terminal with safety rails for agent-driven ordering`,
		Long: `Browse, cart, and place orders at any OrderToGo.com restaurant from the terminal with safety rails for agent-driven ordering
...
Health check: run 'ordertogo-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ordertogo-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ordertogo-pp-cli profile list')")
	...
	// PATCH: Add hand-written local-history and ordering assistant commands
	// without regenerating the printed CLI tree.
	rootCmd.AddCommand(newLastOrderCmd(flags))
	rootCmd.AddCommand(newUsualCmd(flags))
	rootCmd.AddCommand(newSpendingCmd(flags))
	...
	rootCmd.AddCommand(newSelfAliasCmd(flags))
